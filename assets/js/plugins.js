    ...
    t.fn.extend({
        scrollspy: function (n) {
            ...
            var o = function (t, e) {
                ...
                l = "";
            return this.each(function () {
                for (var r = this, s = t(n.container), c = t(r).find("a"), h = 0; h < c.length; h++) {
                    var p = c[h];
                    t(p).on("click", function (a) {
                        ...
                        if (i.length > 0) {
                            ...
                            n.animate ? t("html, body").animate({
                                scrollTop: f
                            }, n.duration) : e.scrollTo(0, f), a.preventDefault()
                        }
                    })
                }
                f(c);
                    ...
                    v = function () {
                        for (var e, a = {
                            ...
                            if (a.top >= h.top && a.top < h.bottom) {
                                var p = h.hash;
                                if (e = i(c, p)) {
                                    n.onChange && l !== p && (n.onChange(h.element, t(r), a), l = p), n.replaceState && history.replaceState({}, "", "/" + p), f(c), e.parent().addClass(n.activeClass);
                                    break
                                }
                            }
                        }!e && "exit" !== l && n.onExit && (n.onExit(t(r), a), f(c), l = "exit", n.replaceState && history.replaceState({}, "", "/"))
                    };
